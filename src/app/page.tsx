...
import { Check, Star, Award, ShieldCheck, Zap, Camera, Play, Video } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="max-w-sm text-muted-foreground text-sm font-body italic leading-relaxed md:text-right"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              { id: 'vid-1', title: 'The Royal Union', thumb: PlaceHolderImages.find(i => i.id === 'hero-1')?.imageUrl, type: 'Wedding Film' },
              { id: 'vid-2', title: 'Fashion Campaign 24', thumb: PlaceHolderImages.find(i => i.id === 'portfolio-fashion-1')?.imageUrl, type: 'Editorial' }
            ].map((video, idx) => (
              <motion.div
                key={video.id}
              ...
              >
                ...
                <div className="absolute bottom-10 left-10 space-y-2">
                  ...
                  <h3 className="text-white font-headline text-3xl uppercase tracking-wider">{video.title}</h3>
                </div>
