    ...
    <div className="pt-32 pb-24 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-24 w-full h-[450px] bg-card rounded-[3rem] border border-border overflow-hidden relative group">
           <div className="absolute inset-0 flex items-center justify-center bg-[url('https://picsum.photos/seed/mumbai-map/1200/450')] bg-cover grayscale opacity-50 transition-all duration-700 group-hover:grayscale-0 group-hover:opacity-80" />
